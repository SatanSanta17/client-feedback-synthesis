...
UPDATE profiles
SET is_admin = true
WHERE email = 'burhanuddin.c@inmobi.com';
```
...
export const metadata = { title: "Settings — Accelerate Synthesis" };
