...
- **Forward-compat to Part 5 (retention).** No bell-level concern. Cleanup deletes rows; Realtime publishes DELETE events to subscribers; the bell already refetches on every event so deletions surface without bespoke handling.
