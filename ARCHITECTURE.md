...
| `structured_json` | JSONB | Nullable. Schema-validated JSON extraction output (PRD-018). Single source of truth for extraction since PRD-031 Part 1; markdown is derived on demand by consumers that still need it. |
