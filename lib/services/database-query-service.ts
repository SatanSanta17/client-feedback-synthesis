...
import { baseSessionQuery } from "./database-query/shared/base-query-builder";
import { dateTrunc } from "./database-query/shared/row-helpers";
import { fetchActiveThemeMap } from "./database-query/shared/theme-helpers";
...
// Moved domains live in ./database-query/domains/ (PRD-023 P5 Inc. 2–3).
// Drill-down family, session_detail, and insights are still inlined below
// pending Increments 4–5.
// ---------------------------------------------------------------------------
