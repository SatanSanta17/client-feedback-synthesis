...
// Moved domains live in ./database-query/domains/ (PRD-023 P5 Inc. 2+).
// Theme widget handlers, drill-down family, session_detail, and insights
// are still inlined below pending Increments 3–5.
// ---------------------------------------------------------------------------
