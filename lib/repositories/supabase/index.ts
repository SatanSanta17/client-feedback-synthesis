// ---------------------------------------------------------------------------
// Supabase Adapter Factories — Re-exports
// ---------------------------------------------------------------------------

export { createProfileRepository } from "./supabase-profile-repository";
export { createClientRepository } from "./supabase-client-repository";
export { createSessionRepository } from "./supabase-session-repository";
export { createTeamRepository } from "./supabase-team-repository";
export { createMasterSignalRepository } from "./supabase-master-signal-repository";
